    ...
    switch (global_data_A37474.control_state) {
        ...
        case STATE_WAIT_FOR_CONFIG:
            ...
            while (global_data_A37474.control_state == STATE_WAIT_FOR_CONFIG) {
                DoA37474();
                DoStartupLEDs();
                if (global_data_A37474.run_time_counter >= LED_STARTUP_FLASH_TIME) {
        ...
        case STATE_FAULT_HEATER_ON:
            ...
            ETMAnalogInputClearFaultCounters(&global_data_A37474.input_hv_v_mon);
            ETMAnalogInputClearFaultCounters(&global_data_A37474.input_top_v_mon);
        ...
        case STATE_FAULT_HEATER_OFF:
            ...
            ETMAnalogInputClearFaultCounters(&global_data_A37474.input_htr_v_mon);
            ETMAnalogInputClearFaultCounters(&global_data_A37474.input_htr_i_mon);
            ETMAnalogInputClearFaultCounters(&global_data_A37474.input_bias_v_mon);
...
void InitializeA37474(void) {
    ...
    ETMEEPromReadPage(0, global_data_A37474.page_data);
    global_data_A37474.ethernet_hv_ref = global_data_A37474.page_data[0];
    global_data_A37474.ethernet_top_ref = global_data_A37474.page_data[1];
    global_data_A37474.ethernet_htr_ref = global_data_A37474.page_data[2];

#endif

    // Initialize off board ADC Inputs

    ETMAnalogInputInitialize(&global_data_A37474.input_adc_temperature,
            MACRO_DEC_TO_SCALE_FACTOR_16(ADC_TEMPERATURE_SENSOR_FIXED_SCALE),
            ADC_TEMPERATURE_SENSOR_FIXED_OFFSET,
            0);


    ETMAnalogInputInitialize(&global_data_A37474.input_hv_v_mon,
            MACRO_DEC_TO_SCALE_FACTOR_16(ADC_HV_VMON_FIXED_SCALE),
            ADC_HV_VMON_FIXED_OFFSET,
            0);
    ETMAnalogInputInitializeRelativeTripLevels(&global_data_A37474.input_hv_v_mon,
            0, //need to figure out target value (must recall this function)
            ADC_HV_VMON_RELATIVE_TRIP_SCALE,
            ADC_HV_VMON_RELATIVE_TRIP_FLOOR,
            ADC_HV_VMON_RELATIVE_TRIP_COUNT);


    ETMAnalogInputInitialize(&global_data_A37474.input_hv_i_mon,
            MACRO_DEC_TO_SCALE_FACTOR_16(ADC_HV_IMON_FIXED_SCALE),
            ADC_HV_IMON_FIXED_OFFSET,
            0);


    ETMAnalogInputInitialize(&global_data_A37474.input_gun_i_peak,
            MACRO_DEC_TO_SCALE_FACTOR_16(ADC_GUN_I_PEAK_FIXED_SCALE),
            ADC_GUN_I_PEAK_FIXED_OFFSET,
            0);


    ETMAnalogInputInitialize(&global_data_A37474.input_htr_v_mon,
    ...
    ETMAnalogInputInitialize(&global_data_A37474.input_htr_i_mon,
            MACRO_DEC_TO_SCALE_FACTOR_16(ADC_HTR_I_MON_FIXED_SCALE),
            ADC_HTR_I_MON_FIXED_OFFSET,
            0);
    ETMAnalogInputInitializeFixedTripLevels(&global_data_A37474.input_htr_i_mon,
            ADC_HTR_I_MON_OVER_LIMIT_ABSOLUTE,
            ADC_HTR_I_MON_UNDER_LIMIT_ABSOLUTE,
            ADC_HTR_I_MON_ABSOLUTE_TRIP_TIME);


    ETMAnalogInputInitialize(&global_data_A37474.input_top_v_mon,
            MACRO_DEC_TO_SCALE_FACTOR_16(ADC_TOP_V_MON_FIXED_SCALE),
            ADC_TOP_V_MON_FIXED_OFFSET,
            0);
    ETMAnalogInputInitializeRelativeTripLevels(&global_data_A37474.input_top_v_mon,
            0, //need to figure out target value (must recall this function)
    ...
    ETMAnalogInputInitialize(&global_data_A37474.pos_5v_mon,
            MACRO_DEC_TO_SCALE_FACTOR_16(POS_5V_FIXED_SCALE),
            POS_5V_FIXED_OFFSET,
            0);


    ETMAnalogInputInitialize(&global_data_A37474.pos_15v_mon,
            MACRO_DEC_TO_SCALE_FACTOR_16(POS_15V_FIXED_SCALE),
            POS_15V_FIXED_OFFSET,
            0);


    ETMAnalogInputInitialize(&global_data_A37474.neg_15v_mon,
    ...
    ETMAnalogOutputInitialize(&global_data_A37474.analog_output_high_voltage,
    ...
    ETMAnalogOutputInitialize(&global_data_A37474.analog_output_top_voltage,
    ...
    ETMAnalogOutputInitialize(&global_data_A37474.analog_output_heater_voltage,
...
void ResetAllFaultInfo(void) {
    ...
    global_data_A37474._FAULT_REGISTER = 0;
    global_data_A37474._WARNING_REGISTER = 0;
    ...
    ETMAnalogInputClearFaultCounters(&global_data_A37474.input_adc_temperature);
    ETMAnalogInputClearFaultCounters(&global_data_A37474.input_hv_v_mon);
    ETMAnalogInputClearFaultCounters(&global_data_A37474.input_hv_i_mon);
    ETMAnalogInputClearFaultCounters(&global_data_A37474.input_gun_i_peak);
    ETMAnalogInputClearFaultCounters(&global_data_A37474.input_htr_v_mon);
    ETMAnalogInputClearFaultCounters(&global_data_A37474.input_htr_i_mon);
    ETMAnalogInputClearFaultCounters(&global_data_A37474.input_top_v_mon);
    ETMAnalogInputClearFaultCounters(&global_data_A37474.input_bias_v_mon);
    ETMAnalogInputClearFaultCounters(&global_data_A37474.input_24_v_mon);
    ETMAnalogInputClearFaultCounters(&global_data_A37474.input_dac_monitor);

    ETMAnalogInputClearFaultCounters(&global_data_A37474.pos_5v_mon);
    ETMAnalogInputClearFaultCounters(&global_data_A37474.pos_15v_mon);
    ETMAnalogInputClearFaultCounters(&global_data_A37474.neg_15v_mon);
...
void DoA37474(void) {
    ...
    if (_T2IF) {
        ...
        if (global_data_A37474.watchdog_set_mode == WATCHDOG_MODE_0) {
            if ((ETMAnalogInputGetReading(&global_data_A37474.input_dac_monitor) > MIN_WD_VALUE_0) &&
                    (ETMAnalogInputGetReading(&global_data_A37474.input_dac_monitor) < MAX_WD_VALUE_0)) {
                global_data_A37474.watchdog_counter = 0;
            ...
            if ((ETMAnalogInputGetReading(&global_data_A37474.input_dac_monitor) > MIN_WD_VALUE_1) &&
                    (ETMAnalogInputGetReading(&global_data_A37474.input_dac_monitor) < MAX_WD_VALUE_1)) {
                global_data_A37474.watchdog_counter = 0;
                global_data_A37474.watchdog_state_change = 1;
         ...
         */
        /*
                slave_board_data.log_data[0] = ETMAnalogInputGetReading(&global_data_A37474.input_gun_i_peak);
                slave_board_data.log_data[1] = ETMAnalogInputGetReading(&global_data_A37474.input_hv_v_mon);
                slave_board_data.log_data[2] = ETMAnalogInputGetReading(&global_data_A37474.input_top_v_mon); //gdoc says low energy
                slave_board_data.log_data[3] = ETMAnalogInputGetReading(&global_data_A37474.input_top_v_mon); //gdoc says high energy
                slave_board_data.log_data[4] = ETMAnalogInputGetReading(&global_data_A37474.input_temperature_mon);
                slave_board_data.log_data[5] = global_data_A37474.heater_warm_up_time_remaining;
                slave_board_data.log_data[6] = ETMAnalogInputGetReading(&global_data_A37474.input_htr_i_mon);
                slave_board_data.log_data[7] = ETMAnalogInputGetReading(&global_data_A37474.input_htr_v_mon);
                slave_board_data.log_data[8] = ETMAnalogOutputGetSetPoint(&global_data_A37474.analog_output_high_voltage);
                slave_board_data.log_data[9] = global_data_A37474.heater_voltage_target;
                slave_board_data.log_data[10] = ETMAnalogOutputGetSetPoint(&global_data_A37474.analog_output_top_voltage); //gdoc says low energy
                slave_board_data.log_data[11] = ETMAnalogOutputGetSetPoint(&global_data_A37474.analog_output_top_voltage); //gdoc says high energy
                slave_board_data.log_data[12] = ETMAnalogInputGetReading(&global_data_A37474.input_bias_v_mon);
...
#ifdef __MODE_MODBUS_MONITOR
        modbus_slave_hold_reg_0x21 = ETMAnalogInputGetReading(&global_data_A37474.input_htr_v_mon);
        modbus_slave_hold_reg_0x22 = ETMAnalogInputGetReading(&global_data_A37474.input_htr_i_mon);
        modbus_slave_hold_reg_0x23 = ETMAnalogInputGetReading(&global_data_A37474.input_top_v_mon);
        modbus_slave_hold_reg_0x24 = ETMAnalogInputGetReading(&global_data_A37474.input_hv_v_mon);
        modbus_slave_hold_reg_0x25 = ETMAnalogInputGetReading(&global_data_A37474.input_temperature_mon) / 100;
        modbus_slave_hold_reg_0x26 = ETMAnalogInputGetReading(&global_data_A37474.input_bias_v_mon) / 10;
        modbus_slave_hold_reg_0x27 = ETMAnalogInputGetReading(&global_data_A37474.input_gun_i_peak) / 10;
        ...
        modbus_slave_hold_reg_0x32 = global_data_A37474._FAULT_REGISTER;
        modbus_slave_hold_reg_0x33 = global_data_A37474._WARNING_REGISTER;
        ...
        ETMAnalogOutputSetPoint(&global_data_A37474.analog_output_high_voltage, global_data_A37474.ethernet_hv_ref);
        ETMAnalogOutputSetPoint(&global_data_A37474.analog_output_top_voltage, global_data_A37474.ethernet_top_ref);
        ...
        //ETMAnalogOutputGetDACValue(&global_data_A37474.analog_output_high_voltage);
        //ETMAnalogOutputGetDACValue(&global_data_A37474.analog_output_top_voltage);
        //ETMAnalogOutputGetDACValue(&global_data_A37474.analog_output_heater_voltage);
        ...
        if (global_data_A37474.control_state != STATE_WAIT_FOR_CONFIG) {
            switch ((global_data_A37474.run_time_counter & 0b111)) {
                ...
                case 0:
                    DACWriteChannel(LTC265X_WRITE_AND_UPDATE_DAC_A, ETMAnalogOutputGetDACValue(&global_data_A37474.analog_output_high_voltage));
                    //ETMCanSlaveSetDebugRegister(0, ETMAnalogOutputGetDACValue(&global_data_A37474.analog_output_high_voltage));
                    break;


                case 1:
                    DACWriteChannel(LTC265X_WRITE_AND_UPDATE_DAC_B, ETMAnalogOutputGetDACValue(&global_data_A37474.analog_output_top_voltage));
                    //ETMCanSlaveSetDebugRegister(1, ETMAnalogOutputGetDACValue(&global_data_A37474.analog_output_top_voltage));
                    break;


                case 2:
                    DACWriteChannel(LTC265X_WRITE_AND_UPDATE_DAC_C, ETMAnalogOutputGetDACValue(&global_data_A37474.analog_output_heater_voltage));
                    //ETMCanSlaveSetDebugRegister(2, ETMAnalogOutputGetDACValue(&global_data_A37474.analog_output_heater_voltage));
                    break;
...
void UpdateFaults(void) {
    ...
    if (global_data_A37474.adc_read_ok) {
        ...
        if (ETMAnalogOutputGetSetPoint(&global_data_A37474.analog_output_heater_voltage) < 1500) {
            ETMAnalogInputClearFaultCounters(&global_data_A37474.input_htr_v_mon);
        }
        ...
        if (ETMAnalogInputFaultOverFixed(&global_data_A37474.input_htr_i_mon)) {
        ...
        if (global_data_A37474.control_state > STATE_HEATER_RAMP_UP) {
            if (ETMAnalogInputFaultUnderFixed(&global_data_A37474.input_htr_i_mon)) {
        ...
        if (ETMAnalogInputFaultOverRelative(&global_data_A37474.input_htr_v_mon)) {
            _FAULT_ADC_HTR_V_MON_OVER_RELATIVE = 1;
        } else if (global_data_A37474.reset_active) {
            _FAULT_ADC_HTR_V_MON_OVER_RELATIVE = 0;
        }

        if (ETMAnalogInputFaultUnderRelative(&global_data_A37474.input_htr_v_mon)) {
        ...
        if (global_data_A37474.control_state >= STATE_POWER_SUPPLY_RAMP_UP) {
            if (ETMAnalogInputFaultOverRelative(&global_data_A37474.input_hv_v_mon)) {
        ...
        if (global_data_A37474.control_state >= STATE_HV_ON) {
            if (ETMAnalogInputFaultUnderRelative(&global_data_A37474.input_hv_v_mon)) {
        ...
        if (global_data_A37474.control_state >= STATE_TOP_READY) {
            if (ETMAnalogInputFaultOverRelative(&global_data_A37474.input_top_v_mon)) {
        ...
        if (global_data_A37474.control_state >= STATE_TOP_READY) {
            if (ETMAnalogInputFaultUnderRelative(&global_data_A37474.input_top_v_mon)) {
        ...
        if (ETMAnalogInputFaultOverFixed(&global_data_A37474.input_bias_v_mon)) {
            _FAULT_ADC_BIAS_V_MON_OVER_ABSOLUTE = 1;
        } else if (global_data_A37474.reset_active) {
            _FAULT_ADC_BIAS_V_MON_OVER_ABSOLUTE = 0;
        }

        if (ETMAnalogInputFaultUnderFixed(&global_data_A37474.input_bias_v_mon)) {
...
void UpdateLEDandStatusOutuputs(void) {
    ...
    if (CheckFault() != 0 || CheckHeaterFault() != 0) {
...
void EnableHeater(void) {
     ...
     */
    ETMAnalogOutputEnable(&global_data_A37474.analog_output_heater_voltage);
...
void DisableHeater(void) {
     ...
     */
    ETMAnalogOutputDisable(&global_data_A37474.analog_output_heater_voltage);
...
void EnableHighVoltage(void) {
     ...
     */
    ETMAnalogOutputEnable(&global_data_A37474.analog_output_high_voltage);
...
void EnableTopSupply(void) {
    ...
    ETMAnalogOutputEnable(&global_data_A37474.analog_output_top_voltage);
...
void DisableHighVoltage(void) {
     ...
     */
    ETMAnalogOutputDisable(&global_data_A37474.analog_output_top_voltage);
    ETMAnalogOutputDisable(&global_data_A37474.analog_output_high_voltage);
...
void UpdateADCResults(void) {
    ...
    if (read_error) {
        ...
        ETMAnalogInputUpdate(&global_data_A37474.input_adc_temperature, read_data[0]);
        ETMAnalogInputUpdate(&global_data_A37474.input_hv_v_mon, (read_data[1] << 4));
        ETMAnalogInputUpdate(&global_data_A37474.input_hv_i_mon, (read_data[2] << 4));
        ETMAnalogInputUpdate(&global_data_A37474.input_gun_i_peak, (read_data[3] << 4));
        ETMAnalogInputUpdate(&global_data_A37474.input_htr_v_mon, (read_data[4] << 4));
        ETMAnalogInputUpdate(&global_data_A37474.input_htr_i_mon, (read_data[5] << 4));
        ETMAnalogInputUpdate(&global_data_A37474.input_top_v_mon, (read_data[6] << 4));
        ETMAnalogInputUpdate(&global_data_A37474.input_bias_v_mon, (read_data[7] << 4));
        ETMAnalogInputUpdate(&global_data_A37474.input_24_v_mon, (read_data[8] << 4));
        ETMAnalogInputUpdate(&global_data_A37474.input_temperature_mon, (read_data[9] << 4));
        ETMAnalogInputUpdate(&global_data_A37474.input_dac_monitor, (read_data[16] << 4));
...
void __attribute__((interrupt, no_auto_psv)) _ADCInterrupt(void) {
    ...
    if (_BUFS) {
        // read ADCBUF 0-2
        global_data_A37474.pos5v_adc_accumulator += ADCBUF0;
        global_data_A37474.pos15v_adc_accumulator += ADCBUF1;
        global_data_A37474.neg15v_adc_accumulator += ADCBUF2;
    } else {
        // read ADCBUF 8-A
        global_data_A37474.pos5v_adc_accumulator += ADCBUF8;
        global_data_A37474.pos15v_adc_accumulator += ADCBUF9;
        global_data_A37474.neg15v_adc_accumulator += ADCBUFA;
    }
    ...
    if (global_data_A37474.accumulator_counter >= 128) {
        ...
        global_data_A37474.pos5v_adc_accumulator >>= 3;
        global_data_A37474.pos15v_adc_accumulator >>= 3;
        global_data_A37474.neg15v_adc_accumulator >>= 3;

        // Store the filtred results
        ETMAnalogInputUpdate(&global_data_A37474.pos_5v_mon, ((unsigned int) global_data_A37474.pos5v_adc_accumulator));
        ETMAnalogInputUpdate(&global_data_A37474.pos_15v_mon, ((unsigned int) global_data_A37474.pos15v_adc_accumulator));
        ETMAnalogInputUpdate(&global_data_A37474.neg_15v_mon, ((unsigned int) global_data_A37474.neg15v_adc_accumulator));

        // clear the accumulators 
        global_data_A37474.pos5v_adc_accumulator = 0;
        global_data_A37474.pos15v_adc_accumulator = 0;
        global_data_A37474.neg15v_adc_accumulator = 0;
    }
}
...
void ETMModbusInit(void) {
    ...
    ETMEEPromReadPage(1, global_data_A37474.page_data1);
    ETMEEPromReadPage(2, global_data_A37474.page_data2);
    ETMEEPromReadPage(3, global_data_A37474.page_data3);
    ETMEEPromReadPage(4, global_data_A37474.page_data4);
    ETMEEPromReadPage(5, global_data_A37474.page_data5);
    ETMEEPromReadPage(6, global_data_A37474.page_data6);
    ETMEEPromReadPage(7, global_data_A37474.page_data7);
    ETMEEPromReadPage(8, global_data_A37474.page_data8);
    ETMEEPromReadPage(9, global_data_A37474.page_data8);
    ETMEEPromReadPage(10, global_data_A37474.page_data8);
    ...
    for (i = 0; i < 14; i++) {//0-13
        ModbusSlaveHoldingRegister[i] = global_data_A37474.page_data1[0 + i];
    }
    for (i = 0; i < 14; i++) {//14-27
        for (j = 14; j < 28; j++) {
            ModbusSlaveHoldingRegister[j] = global_data_A37474.page_data2[0 + i];
        }
    }
    for (i = 0; i < 14; i++) {//28-41
        for (j = 28; j < 42; j++) {
            ModbusSlaveHoldingRegister[j] = global_data_A37474.page_data3[0 + i];
        }
    }
    for (i = 0; i < 14; i++) {//42-55
        for (j = 42; j < 56; j++) {
            ModbusSlaveHoldingRegister[j] = global_data_A37474.page_data4[0 + i];
        }
    }
    for (i = 0; i < 9; i++) {//56-69
        for (j = 56; j < 65; j++) {
            ModbusSlaveHoldingRegister[j] = global_data_A37474.page_data5[0 + i];
        }
    }
    ...
    //Slave Bits
    for (i = 0; i < 14; i++) {//0-13
        ModbusSlaveBit[i] = global_data_A37474.page_data6[0 + i];
    }
    for (i = 0; i < 14; i++) {//14-27
        for (j = 14; j < 28; j++) {
            ModbusSlaveBit[j] = global_data_A37474.page_data7[0 + i];
        }
    }
    for (i = 0; i < 14; i++) {//28-41
        for (j = 28; j < 42; j++) {
            ModbusSlaveBit[j] = global_data_A37474.page_data8[0 + i];
        }
    }
    for (i = 0; i < 14; i++) {//42-55
        for (j = 42; j < 56; j++) {
            ModbusSlaveBit[j] = global_data_A37474.page_data9[0 + i];
        }
    }
    for (i = 0; i < 9; i++) {//56-69
        for (j = 56; j < 65; j++) {
            ModbusSlaveBit[j] = global_data_A37474.page_data10[0 + i];
        }
    }
        ...
        case FUNCTION_WRITE_BIT:
            ...
            if ((ptr->write_value == 0x0000) || (ptr->write_value == 0xFF00)) {
                ...
                if ((coil_index = 0) && (coil_index < 14)) {
                    global_data_A37474.page_data6[coil_index] = ptr->write_value;
                    ETMEEPromWritePage(6, global_data_A37474.page_data6);
                }
                if ((coil_index >= 14) && (coil_index < 28)) {
                    global_data_A37474.page_data7[coil_index - 14] = ptr->write_value;
                    ETMEEPromWritePage(7, global_data_A37474.page_data7);
                }
                if ((coil_index >= 28) && (coil_index < 42)) {
                    global_data_A37474.page_data8[coil_index - 28] = ptr->write_value;
                    ETMEEPromWritePage(8, global_data_A37474.page_data8);
                }
                if ((coil_index >= 42) && (coil_index < 56)) {
                    global_data_A37474.page_data9[coil_index - 42] = ptr->write_value;
                    ETMEEPromWritePage(9, global_data_A37474.page_data9);
                }
                if ((coil_index >= 56) && (coil_index < 65)) {
                    global_data_A37474.page_data10[coil_index - 56] = ptr->write_value;
                    ETMEEPromWritePage(10, global_data_A37474.page_data10);
                }
            } else {
                ptr->received_function_code = ptr->function_code;
                ptr->function_code = EXCEPTION_FLAGGED;
        ...
        case FUNCTION_WRITE_REGISTER:
            ...
            if ((byte_index > 9) && (byte_index < 14)) { // If holding reg's 0x0A - 0x0D change
                if (ptr->write_value < 256) {
                    ...
                    if ((coil_index = 0) && (coil_index < 14)) {
                        global_data_A37474.page_data1[coil_index] = ptr->write_value;
                        ETMEEPromWritePage(1, global_data_A37474.page_data1);
                    }
                    if ((coil_index >= 14) && (coil_index < 28)) {
                        global_data_A37474.page_data2[coil_index - 14] = ptr->write_value;
                        ETMEEPromWritePage(2, global_data_A37474.page_data2);
                    }
                    if ((coil_index >= 28) && (coil_index < 42)) {
                        global_data_A37474.page_data3[coil_index - 28] = ptr->write_value;
                        ETMEEPromWritePage(3, global_data_A37474.page_data3);
                    }
                    if ((coil_index >= 42) && (coil_index < 56)) {
                        global_data_A37474.page_data4[coil_index - 42] = ptr->write_value;
                        ETMEEPromWritePage(4, global_data_A37474.page_data4);
                    }
                    if ((coil_index >= 56) && (coil_index < 65)) {
                        global_data_A37474.page_data5[coil_index - 56] = ptr->write_value;
                        ETMEEPromWritePage(5, global_data_A37474.page_data5);
                    }
